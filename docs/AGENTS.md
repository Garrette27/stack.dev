...
4. Overexposure (API too complex)
5. Pass-Through Method/Variable
6. Repetition (code duplication)
7. Special-General Mixture (mixing general and special-purpose code)
...
13. Hard to Describe (comment is hard to write)
14. Nonobvious Code
